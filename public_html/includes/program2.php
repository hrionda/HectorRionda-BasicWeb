...
<html>
  <head>
    <title>Rionda, H, Program 2</title>
	    ...
	    <table style="width: 50%; padding-right: 8%;">
		  ...
		  <tr>
		    ...
		    <td style="width: 20%;">
			  ...
			  <input type="submit" name="Find" value="Find" style="width: 100px">
			  <input type="submit" name="Modify" value="Modify" style="width: 100px">
			  <input type="submit" name="Delete" value="Delete" style="width: 100px">
			  <input type="reset" name="ClearScreen" value="ClearScreen" style="width: 100px">
			</td>
		  </tr>
